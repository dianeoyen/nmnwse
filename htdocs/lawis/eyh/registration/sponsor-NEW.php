...
function checkForm()
{
    ...
    {
        alert('Bad phone number - please use format 505-xxx-xxxx, you put in:'+gephone.value+':'+gdphone.value+':');
...
<form method="post" name="regform" action="sponsor-reg.php?printable=1">
 ...
 <tr> 
   ...
   <td> 
   	<?php $r=array("","Teacher","Parent","Counselor","Other");
  ...
  <tr> 
   ...
   <td> 
    <input name="ephone" type="text" id="ephone" size="12" maxlength="16"  value="<?php print($row['ephone']);?>"></td>
 </tr>
  <tr> 
   <td width="100">Daytime or School Phone*</td>
   <td> 
    <input name="dphone" type="text" id="dphone" size="12" maxlength="16"  value="<?php print($row['dphone']);?>"></td>
 </tr>
 <tr> 
...
if($row['Bringing']!="")
	{
	echo "You are currently listed as Bringing the following students";
	print($row['Bringing']);
	echo "<br>If you need to remove a student from this list, please <a href=\"http://nmnwse.org/lawis/eyh/contact/\">contact</a> the registrar.";
	}
?>
