...
teacher_sponsor,stem,interest,attend,needs,allergies,accept,parent,parent_phone,emergency,relationship,emergency_phone from nmnwse_org.registration");	
    ...
    // XLS Data Cell
				...
				xlsWriteLabel(5,8,"Phone");
                xlsWriteLabel(5,9,"Email");
				xlsWriteLabel(5,10,"School");
				xlsWriteLabel(5,11,"Grade");
                xlsWriteLabel(5,12,"Teacher Sponsor");
                xlsWriteLabel(5,13,"stem");
                xlsWriteLabel(5,14,"Interest");
                xlsWriteLabel(5,15,"Attend");
				xlsWriteLabel(5,16,"Needs");
				xlsWriteLabel(5,17,"Allrgies");
				xlsWriteLabel(5,18,"Accept");
                xlsWriteLabel(5,19,"Parent");
				xlsWriteLabel(5,20,"Parent Phone");
				xlsWriteLabel(5,21,"Emergency");
				xlsWriteLabel(5,22,"Relationship");
				xlsWriteLabel(5,23,"Emergency Phone");
