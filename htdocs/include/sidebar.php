...
<nav>
  <img src="http://nmnwse.org/Images/frillinv.gif" class="decoration" width="100%">
  <ul>
    <li>
    ...
    <li>
      <a href="http://nmnwse.org/donate.php">Donate</a>
      <ul>
	<li>
	  <a href="http://nmnwse.org/NonProfitStatus.php">501(c)(3) info</a>
	</li>
      </ul>
    </li>
    <li>
      <a href="http://nmnwse.org/eyh">Expanding Your Horizons</a>
      <ul>
	<li>
	  <a href="http://nmnwse.org/ceyh/">Albuquerque</a>
	</li>
	<li>
	  <a href="http://nmnwse.org/carlsbad-eyh/">Carlsbad</a><! img src="http://nmnwse.org/Images/new.gif">
	</li>
	<li>
    ...
    <li>
      ...
      <ul>
	<li>
	  <a href="http://nmnwse.org/Listserver.php">Listserver</a>
	</li>
	<li>
	  <a href="mailto:NMNWSE_Board-l@list.unm.edu">Email the Board</a>
	</li>
	<li>
	  <a href="mailto:nmnwse-l@list.unm.edu">Email all NMNWSE</a>
	</li>
	<li>
	  <a href="mailto:webmaster@nmnwse.org">Email webmaster</a>
	</li>
      </ul>
    </li>
    <li>
  ...
  <img src="http://nmnwse.org/Images/frill.gif" class="decoration" width="100%">
