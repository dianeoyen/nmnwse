...
<html lang="en">
  ...
  <head>
    <meta charset="UTF-8">
    <title>Silver City EYH Expanding Your Horizons</title>
    <link rel="stylesheet" href="../css/nmnwse.css">
    <link rel="stylesheet" href="../css/sceyh.css">
  </head>
  
  <body>
    <header>
      <?php
        include("../include/pagetop_sceyh.php");
        ?>
    </header>
    ...
    <main>
      ...
      <div class=img_bar>
        <img src="http://nmnwse.org/sceyh/images/EYH_geology_MaryAliceMurphy_GCBeat.jpg"
             alt="Girls doing geology at EYH"/>
        <img src="http://nmnwse.org/sceyh/images/s_0224_crop.jpg"
             alt="Girls at EYH"/>
        <img src="http://nmnwse.org/sceyh/images/sceyh1_crop.jpg"
             alt="Girls in lab coats at EYH"/>        
      </div>

      <div class=wrapper>
        <div class=img_bar_vert>
          <img src="http://nmnwse.org/sceyh/images/s_0041.jpg"
               alt="Girl with solar panel at EYH"/>
          <img src="http://nmnwse.org/sceyh/images/EYH_suturing_MaryAliceMurphy_GCBeat.jpg"
               alt="Girls suturing at EYH"/>
          <img src="http://nmnwse.org/sceyh/images/s_0039.jpg"
               alt="Girls with solar panel at EYH"/>
        </div>

        <div class="content">
          
          <img src="http://nmnwse.org/Images/SCEYHlogo_150.jpg"
	    ...
	    <li>
          ...
          <h3>Previous Silver City EYH Conferences</h3>
          <ul>
            <li>
            ...
            <li>
              <a href="index15.php"> 2015 Silver City EYH webpage</a>
            </li>
            <li>
              <a href="index14.php"> 2014 Silver City EYH webpage</a>
            </li>
            <li>
              <a href="index13.php"> 2013 Silver City EYH webpage</a>
              and
              <a href="SCEYH_20130316_photos.pdf">Photos from the 2013 conference</a>
            </li>
            <li>
              <a href="index12.php"> 2012 Silver City EYH webpage</a>
            </li>
            <li>
              <a href="index11.php"> 2011 Silver City EYH webpage</a>
            </li>
            <li>
              <a href="index10.php"> 2010 Silver City EYH webpage</a>
            </li>
            <li>
              <a href="index09.php"> 2009 Silver City EYH webpage</a>
            </li>
            <li>
              <a href="index08.php"> 2008 Silver City EYH webpage</a>
            </li>
            <li>
              <a href="index07.php"> 2007 Silver City EYH webpage</a>
            </li>
          </ul>
        </div>
      </div>
