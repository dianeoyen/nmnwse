...
<P>
<B>The deadline to register online and to submit abstracts for the technical sessions is Oct 3, 2008.</B> &nbsp;Online registrations and abstracts
...
Please contact the <a href="http://nmnwse.org/AM/2008/contacts.php">registrar</a> to confirm space availability before submitting a post-deadline registration.
...
<P><B>TECHNICAL PRESENTATION NOTES</b>
<a name="techpres">
...
<P>Post-deadline technical abstracts (ones submitted after Oct 3, 2008) may be relegated to
the poster session even if you indicate you prefer to give a talk - contact the <a href="http://nmnwse.org/AM/2008/contacts.php">Technical Chair</a> for scheduling of your
presentation.

<P>
Note students and members with exceptional circumstances are eligible to apply for a meeting scholarship (<a href="#scholarship">details below</a>), and we are offering reduced 2009 membership rates for new members attending the annual meeting.
...
<P>
<a name="accompany">
<B>Accompanying adult</b> (12+) registration for the full meeting includes the Friday evening reception, the wine and cheese reception during the poster session, and the conference dinner. A reduced rate is offered for those who will only join us Saturday evening. <b>Accompanying children</b> (11 and under) are also welcome to attend the Friday evening reception at no charge, but only need to be included on the registration form if they will be at the Saturday reception and dinner (even if under 4 so free, as we need to give the count to the caterer). Accompanying persons 18 and under are welcome to attend the technical sessions at no charge (if interested). Accompanying adults over 18 wishing to attend the business meeting or technical talks would need to register as attendees; however, accompanying adults registered for dinner may come to the poster session/pre-dinner reception without registering as attendees. 
...
<P>
<b>Lunch and Breakfast are on your own.</b> A Continental breakfast is included with rooms at the Sierra Grande Lodge (conference hotel). Rooms at the Pelican do not include breakfast, but there is a breakfast place next door to the Pelican.
There are several places to purchase lunch in the neighborhood. 
While the restaurant at the Sierra Grande Lodge is currently closed, they remain hopeful that 
it will open by October 1, well before our conference.
...
Please see the <a href="http://nmnwse.org/AM/2008/hotel.php">conference hotel page</a> for hotel contact info, discounted meeting rates, and further details. Both the Sierra Grande Lodge and Spa and the nearby Pelican Spa are small, and so we encourage you to reserve your accommodations early.
