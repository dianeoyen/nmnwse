...
<P>
<B>Attendee registration</b> includes a Friday evening reception, snacks during the meeting, the wine and cheese reception during the poster session, and the conference dinner, plus covering our facilities costs. 
We encourage all attendees to come for the full meeting. In exceptional circumstances we may be able to offer a reduced rate for attendees (and their accompanying persons) who can only come to the technical sessions - please <a href="../contacts.php">contact the meeting chair</a> and note any agreed upon reduction in the comment section below. Students and members with exceptional circumstances may also apply for a meeting scholarship (see below).


<P>
<B>Accompanying Adult</b> registration includes the Friday evening reception, the wine and cheese reception during the poster session, and the conference dinner. <b>Accompanying children</b> are also welcome to attend the Friday evening reception at no charge, but only need to be included on the registration form if they will be at the Saturday reception and dinner (even if under 4 so free, as we need to give the count to the caterer). Accompanying minors (18 and under) are welcome to attend the technical sessions at no charge (if interested). Accompanying adults over 18 wishing to attend the business meeting or technical talks would need to register as attendees; however, accompanying adults registered for dinner may come to the poster session/pre-dinner reception without registering as attendees. 
