...
<P><b>If you are interested in helping with NMNWSE Central Chapter Expanding Your Horizons conferences (CEYH), please complete the following information.</b> After submitting the form electronially, you will be contacted by a Planning Committee member to follow up on your interests. You will also be added to the planning committee listserver if you check that box in the general preference section below (or see the <a href="../volunteer.php">volunteer page</a> for instructions to add yourself).
...
<P>This form can be submitted at any time.
<!--
, but <b>workshop presenters must return it by Dec 15 for their workshop to be included in the EYH registration mailing</b>. 
-->
Both new and returning volunteers are both welcome to use this form. 
...
<table><tr><td valign="top">
  ...
  <input type="checkbox" name="CEYHnoInterest" value="RemoveMyContactInfo"> 
    </td><td valign="top">
  <B>I can no longer help - Please remove me from your contact lists and listservers</B>
</td></tr></table>
</td></tr><tr><td align="center" bgcolor="#45A1C8">
<B>CEYH PREFERENCES:</b>
</td></tr><tr><td>
<B>Please check all that apply.</b>
...
<table><tr><td valign="top">
  ...
  <input type="checkbox" name="CEYHComm" value="GeneralPlanningInterest"> &nbsp; 
    </td><td valign="top">
   <B>I would like to be involved with EYH advance planning</B>
</td></tr><tr><td valign="top">
  <input type="checkbox" name="CEYHDayOf" value="DayOfHelp_General"> &nbsp;
    </td><td valign="top">
   <B>I'd like to help on the day of EYH</B> (not as presenter).
</td></tr><tr><td valign="top">
  <input type="checkbox" name="Workshop" value="Present"> &nbsp;
    </td><td valign="top">
    <B>I would like to do a Student Workshop</B>
      <br>Brief description:
      <br><textarea name="WorkshopDetails" rows="3" cols="65" wrap="Virtual"></textarea>
</td></tr><tr><td valign="top">
  <input type="checkbox" name="AdultProgram" value="Present"> &nbsp;
    </td><td valign="top">
    <B>I would like to make a presentation to the Adult Participants</B>
    <br>Brief description:
    <br><textarea name="AdultProgDetails" rows="4" cols="65" wrap="Virtual"></textarea>
</td></tr><tr><td valign="top">
  <input type="checkbox" name="Keynote" value="Speaker"> &nbsp;
    </td><td valign="top">
    <B>I am interested in being or would like to suggest a Keynote Speaker</B>
    <br>please enter topic, and contact information if you are suggesting someone else.
    <br> <textarea name="KeynoteDetails" rows="4" cols="65" wrap="Virtual"></textarea>
</td></tr><tr><td valign="top">
...
<P>
<B>Badge Information</b>: If you will be attending EYH (as a presenter or other volunteer), please<br> enter your name, title, employer, and occupation as you would like it to read on your badge
<br>
